#!/usr/bin/env python3
"""Brooks Lab MSLD charge-renormalization helper used in this project.

Separated from the original research notebook during repository cleanup so that
lab-provided methodology/infrastructure is clearly distinguished from the
project-specific workflow and analysis code.
"""
