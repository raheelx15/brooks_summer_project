...
# NOTE ON PROVENANCE
# This is Brooks Lab / MSLD workflow helper code used during the project.
# It is separated from the portfolio notebook to distinguish lab-provided
# methodology/infrastructure from Raheel Sarwar's project-specific workflow code.
